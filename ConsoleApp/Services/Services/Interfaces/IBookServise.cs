...
namespace ConsoleApp.Services.Services.Interfaces
{
    ...
    {
        public Task<string> CreateAsync(int id, string name,  int numberofthebook, string information, double price, double discountprice, bool bookInStock, BookCategory category);
