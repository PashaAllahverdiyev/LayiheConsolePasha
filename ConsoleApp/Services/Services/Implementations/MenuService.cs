...
namespace ConsoleApp.Services.Services.Implementations
{
    public class MenuService
    {
        ...
        private User[] Users = { new User { UserName = "Pasha", Password = "Pasha123" } };
             ...
             public async Task ShowAdmin()
        {
            ...
            string sentence = "Welcome to my Library";
             ...
             public async Task ShowUser()
        {
            ...
            private async Task CreateBook()
            {
                ...
                string message = await _bookService.CreateAsync(id, name, numberofthebook, information, price, discountprice, bookInStock, category);
                Console.WriteLine(message);
            }
