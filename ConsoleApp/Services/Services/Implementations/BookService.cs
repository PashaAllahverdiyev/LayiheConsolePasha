...
namespace ConsoleApp.Services.Services.Implementations
{
    public class BookService : IBookServise
    {
        ...
        public async Task<string> CreateAsync(int id, string name, int numberofthebook, string information, double price, double discountprice, bool bookInStock, BookCategory category)
        {
            ...
            Book book = new Book(name, numberofthebook, information,price, discountprice, bookInStock, category,  bookWriter);
